...
contract PublicDocument is BasicDocument, RevokableDocument, TransfarableDocument {
     ...
     */
    function getDocument(bytes32 document) public view returns (address, address, uint256) {
     ...
     */
    function verifyDocument(address recipient, bytes32 document) public view returns (bool) {
